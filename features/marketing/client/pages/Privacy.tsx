    ...
    <PublicLayout>
      <div className="min-h-screen bg-background pt-32 pb-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="font-serif font-light text-[oklch(0.94_0.008_78)] text-4xl lg:text-5xl leading-tight mb-12">
            Privacy Policy
          </h1>
          <div className="prose prose-invert prose-sm max-w-none font-sans text-[oklch(0.70_0.012_72)] leading-relaxed space-y-8">
            <p className="text-[oklch(0.55_0.010_70)] text-xs tracking-widest uppercase font-sans">Last updated: May 2026</p>

            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">1. Information We Collect</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">2. How We Use Your Information</h2>
              <p>We use the information you provide to:</p>
              <ul className="list-disc list-inside mt-3 space-y-2 text-[oklch(0.65_0.010_70)]">
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">3. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">4. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">5. Security</h2>
              <p>
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">6. Your Rights</h2>
              <p>
                You may request access to, correction of, or deletion of personal information we hold about you by contacting us at{" "}
                <a href="mailto:info@theriverslodge.com" className="text-[oklch(0.72_0.095_78)] hover:underline">
            ...
            <section>
              <h2 className="font-serif font-light text-[oklch(0.88_0.008_78)] text-2xl mb-4">7. Contact</h2>
              <p>
                Questions about this policy may be directed to:
              </p>
              <address className="not-italic mt-4 text-[oklch(0.65_0.010_70)] space-y-1">
