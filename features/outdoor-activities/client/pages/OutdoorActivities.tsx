...
// build: 20260706-2200-upland-birds-tile-fixed
      ...
      <section className="relative hero-full flex items-end pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-5 lg:px-14 w-full">
          ...
          <p className="font-sans text-white/65 max-w-lg leading-relaxed mb-10" style={{ fontSize: "0.9375rem" }}>
            Thousands of privately managed acres along the Marais des Cygnes river bottom.
          </p>
          <p className="font-sans text-white/65 max-w-lg leading-relaxed mb-10" style={{ fontSize: "0.9375rem" }}>
            World class waterfowl & turkey hunting, trophy whitetail, upland gamebirds, premier fishing opportunities, and more — one hour south of Kansas City.
          </p>
