// DAL helpers for auth-related user data, extracted from features/_core/server/db.ts
// TODO: These functions (upsertUser, getUserByOpenId, getAllUsers) are also defined in
